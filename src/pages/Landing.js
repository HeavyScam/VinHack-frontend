    ...
    if (loading) {
        return (
            <div className="loader bounce2">
                ...
                <h1 style={{ color: 'white', paddingTop: '230px', fontWeight: '700' }} className="txt">HOSTEL HOPPER</h1>
        ...
        <>
            <header className="sticky fade-in-down top-0 z-50 grid grid-cols-3 drop-shadow-md p-5 md:px-10 " style={{ display: "flex", marginTop: '1%' }}>
                <a href='/'>
                    <div>
                        ...
                        <span className="text-white nav" style={{ fontSize: "20px", marginLeft: '64px', fontWeight: '600' }}>HOSTEL HOPPER</span>
            ...
            <div className="grid grid-cols-3 drop-shadow-md p-5 md:px-10 fade-in-left top" style={{ display: "flex", marginTop: "15%" }}>
                <div className='bodytxt'>
                    <span className="text-white sml-txt" style={{ fontSize: "24px", fontWeight: "300" }}>WANT TO CHANGE ROOMS?</span>
                    ...
                    <button className=" text-white btn1 flex-end font-bold py-2 p-8 rounded-2xl" style={{ fontSize: "16px", marginTop: "1%" }} onClick={redirect}>FIND ROOM</button>
                    <div className=" text-white flex-end font-bold" style={{ borderRadius: "12px", float: "right", fontSize: "16px" }}>
                    </div>
                </div>
                <img src={Keys} alt="image1" className="keys" style={{ position: 'absolute', right: '100px', }} />
            </div>
